...
const GreenVillasPage = () => {
    ...
    return(
      ...
      >
          ...
          />
          <ProjectsBanner data={t("projetos", { returnObjects: true }).projects.greenvilla.menu} />
          <ProjectsInfo
              data={t("projetos", { returnObjects: true }).projects.greenvilla.info}
          />
          <ProjectsFeatures
              data={t("projetos", { returnObjects: true }).projects.greenvilla.info.features}
          />
          <ProjectsMap
