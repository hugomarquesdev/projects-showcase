...
// Video asset
import video from "../../videos/Puro_resumo.mp4"
import poster from "../../images/video-posters/puroPoster.jpg"
...
const PuroPage = () => {
    ...
    return(
      ...
      >
          ...
          />
          <ProjectsBanner data={t("projetos", { returnObjects: true }).projects.puro.menu} />
          <ProjectsVideo 
              data={video} 
              poster={poster} 
          />
          ...
          />
          <ProjectsImage 
              data={t("projetos", { returnObjects: true }).projects.puro.image2}
          />
          <ProjectsInfo
              data={t("projetos", { returnObjects: true }).projects.puro.info}
          />
          <ProjectsFeatures
              data={t("projetos", { returnObjects: true }).projects.puro.info.features}
          />
          <ProjectsFeatures
              data={t("projetos", { returnObjects: true }).projects.puro.info.features2}
          />
          <ProjectsMap
