...
const VillarPage = () => {
    ...
    return(
      ...
      >
          ...
          />
          <ProjectsBanner data={t("projetos", { returnObjects: true }).projects.villar.menu} />
          <ProjectsInfo
              data={t("projetos", { returnObjects: true }).projects.villar.info}
          />
          <ProjectsFeatures
              data={t("projetos", { returnObjects: true }).projects.villar.info.features}
          />
          <ProjectsMap
              data={t("projetos", { returnObjects: true }).projects.villar.map}
          />
          <Form 
