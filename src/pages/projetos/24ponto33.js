...
// Video asset
import video from "../../videos/24ponto33PEQ.mp4"
import poster from "../../images/video-posters/pontoPoster.jpg"
...
const PontoPage = () => {
  ...
  return (
      ...
      >
        ...
        />
        <ProjectsBanner data={t("projetos", { returnObjects: true }).projects.ponto.menu} />
        <ProjectsVideo
          data={video}
          poster={poster}
        />
        ...
        />
        <ProjectsFeatures
          data={t("projetos", { returnObjects: true }).projects.ponto.info.features}
        />
        <ProjectsMap
