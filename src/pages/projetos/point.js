...
import video from "../../videos/PU_Point.mp4"
import poster from "../../images/video-posters/pointPoster.jpg"
...
const PointPage = () => {
    ...
    return(
      ...
      >
          ...
          />
          <ProjectsBanner data={t("projetos", { returnObjects: true }).projects.point.menu} />
          <ProjectsVideo 
              data={video} 
              poster={poster} 
          />
          ...
          />
          <ProjectsFeatures
              data={t("projetos", { returnObjects: true }).projects.point.info.features}
          />
          <ProjectsMap
