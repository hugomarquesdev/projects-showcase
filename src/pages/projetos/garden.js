...
const GardenPage = () => {
  ...
  return (
    <Layout form={t("global", { returnObjects: true }).form} hideForm>
      ...
      />
      <ProjectsBanner
        data={t("projetos", { returnObjects: true }).projects.garden.menu}
      />
      ...
      <ProjectsFeatures
        data={
          t("projetos", { returnObjects: true }).projects.garden.info.features
        }
      />
      <ProjectsFeatures
        data={
          t("projetos", { returnObjects: true }).projects.garden.info.features2
        }
      />
      <ProjectsMap
