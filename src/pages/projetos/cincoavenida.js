...
// Video asset
import video from "../../videos/5avenidaDESKTOP pequeno.mp4"
import poster from "../../images/video-posters/cincoPoster.jpg"
...
const CincoAvenidaPage = () => {
    ...
    return(
      ...
      >
          ...
          />
          <ProjectsBanner data={t("projetos", { returnObjects: true }).projects.cinco.menu} />
          <ProjectsVideo 
              data={video} 
              poster={poster} 
          />
          ...
          />
          <ProjectsFeatures
              data={t("projetos", { returnObjects: true }).projects.cinco.info.features}
          />
          <ProjectsMap
