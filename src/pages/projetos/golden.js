...
// Video asset
import video from "../../videos/puro-golden.mp4"
import poster from "../../images/video-posters/goldenPoster.jpg"
...
const GoldenPage = () => {
    ...
    return(
        ...
        >
            ...
            />
            <ProjectsBanner data={t("projetos", { returnObjects: true }).projects.golden.menu} />
            <ProjectsVideo 
                data={video} 
                poster={poster} 
            />
            <ProjectsImage 
                data={t("projetos", { returnObjects: true }).projects.golden.image}
                shadow
            />
            <ProjectsInfo
                data={t("projetos", { returnObjects: true }).projects.golden.info}
            />
            <ProjectsFeatures
                data={t("projetos", { returnObjects: true }).projects.golden.info.features}
            />
            <ProjectsMap
                data={t("projetos", { returnObjects: true }).projects.golden.map}
            />
            <Form 
