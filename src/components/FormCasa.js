                    ...
                    {data.group.map((data, i) => (
                      ...
                      >
                        <span
                          ...
                          style={{
                            backgroundColor:
                              isSelected === data && white
                                ? "#000"
                                : isSelected === data && !white && "#fff",
                          }}
                        />
                        <h5>{data}</h5>
                      </button>
...
const StyledForm = styled.div`
  background: ${(props) =>
    props.transparent ? "transparent" : props.white ? "#fff" : "#2c2c2c"};
      ...
      form {
        ...
        .grid {
          ...
          label {
            ...
            input {
              ...
              border: none;
              border-bottom: ${(props) =>
                props.white ? "1px solid #000" : "solid 1px"};
            ...
            .city {
              ...
              button {
                ...
                .selection {
                  ...
                  margin-right: 1em;
                  border: ${(props) =>
                    props.white ? "1px solid #000" : "1px solid #ffffff"};
                }
              }
            }
          }
        ...
        .messageLbl {
          ...
          textarea {
            ...
            color: ${(props) => (props.white ? "#000" : "#ebebeb")};
            border: ${(props) =>
              props.white ? "1px solid #000" : "1px solid #ebebeb"};
          }
        }
