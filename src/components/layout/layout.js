...
const Layout = ({ children, fourOhFour, form, openNewsletter, dispatch, hideForm, hideNewsletter }) => {
    ...
    useEffect(() => {
        dispatch(setNews(data.allWpPost.nodes))
    })
    ...
    return (
        <StyledLayout id="top">
            ...
            <CSSTransition in={openNewsletter} timeout={250} classNames="cta-switch" unmountOnExit>
                <FormNewsletter />
            </CSSTransition>
